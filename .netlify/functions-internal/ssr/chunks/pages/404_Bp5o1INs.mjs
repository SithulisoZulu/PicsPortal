...
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$404;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "SITE_PAGE": "404" }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16"> <div class="xl:pt-24 w-full xl:w-1/2 relative pb-12 lg:pb-0"> <div class="relative"> <div class="absolute"> <div class=""> <h1 class="my-2 text-gray-800 font-bold text-2xl">
...
export { $$Layout as $, API_BASE_URL as A, PHOTOS_PER_PAGE as P, SITE_NAME as S, VIDEOS_PER_PAGE as V, _404 as _, $$Link as a, $$Logosm as b, $$Avatar as c, $user as d, $$BackToTop as e, SITE_DESCRIPTION as f, SITE_CONTENT_SOURCE as g, $$Footer as h, addUser as i, links as l };
