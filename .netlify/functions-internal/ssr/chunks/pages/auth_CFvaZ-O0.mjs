...
import { g as $$Button, h as $$Input, i as $$Logo } from './_id__DNo7kAhh.mjs';
import { S as SITE_NAME, b as $$Logosm } from './404_Bp5o1INs.mjs';
import 'clsx';
...
//     console.log("clicked")
// }, false);
<\/script> -->`])), maybeRenderHead(), renderComponent($$result, "ModalCloser", $$ModalCloser, { "modal": "#loginModal" }), renderComponent($$result, "Logosm", $$Logosm, {}), SITE_NAME, addAttribute(`/api/auth/login.json`, "action"), renderComponent($$result, "Input", $$Input, { "type": "email", "id": "email", "name": "email", "placeholder": "Enter email address", "required": true, "autofocus": false }), renderComponent($$result, "Input", $$Input, { "type": "password", "id": "password", "name": "password", "placeholder": "Enter your password", "required": true, "autofocus": false }), renderComponent($$result, "Button", $$Button, { "type": "submit" }, { "default": ($$result2) => renderTemplate`Sign in` }), renderComponent($$result, "Button", $$Button, { "type": "submit", "outline": true }, { "default": ($$result2) => renderTemplate`Forgot password?` }));
...
<\/script> -->`])), maybeRenderHead(), renderComponent($$result, "ModalCloser", $$ModalCloser, { "modal": "#signinModal" }), renderComponent($$result, "Logosm", $$Logosm, {}), SITE_NAME, addAttribute(`${Astro2.url}/register.json`, "action"), renderComponent($$result, "Input", $$Input, { "type": "text", "id": "name", "name": "name", "placeholder": "Enter full name", "required": true, "autofocus": false }), renderComponent($$result, "Input", $$Input, { "type": "email", "id": "email", "name": "email", "placeholder": "Enter email address", "required": true, "autofocus": false }), renderComponent($$result, "Input", $$Input, { "type": "password", "id": "password", "name": "password", "placeholder": "Enter your password", "required": true, "autofocus": false }), renderComponent($$result, "Button", $$Button, { "type": "submit" }, { "default": ($$result2) => renderTemplate`Signup` }));
